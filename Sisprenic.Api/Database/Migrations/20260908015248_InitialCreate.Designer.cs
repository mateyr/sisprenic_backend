...
namespace Sisprenic.Api.Database.Migrations
{
    ...
    [Migration("20260908015248_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sisprenic.Domain.Entities.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Sisprenic.Domain.Entities.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("loan", null, t =>
                        {
                            t.HasCheckConstraint("CK_Loan_ValidStatus", "status IN (0, 1)");
                        });
                });

            modelBuilder.Entity("Sisprenic.Domain.Entities.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Sisprenic.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Sisprenic.Domain.Entities.Loan", b =>
                {
                    b.HasOne("Sisprenic.Domain.Entities.Client", "Client")
                        .WithMany("Loans")
            ...
            modelBuilder.Entity("Sisprenic.Domain.Entities.Menu", b =>
                {
                    b.HasOne("Sisprenic.Domain.Entities.Menu", "ParentMenu")
                        .WithMany("SubMenus")
            ...
            modelBuilder.Entity("Sisprenic.Domain.Entities.Payment", b =>
                {
                    b.HasOne("Sisprenic.Domain.Entities.Loan", "Loan")
                        .WithMany("Payments")
